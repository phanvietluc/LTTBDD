...
import 'package:viet_luc63132246_flutter/fruit_store/page_capnhat_sp.dart';
import 'package:viet_luc63132246_flutter/fruit_store/page_chitiet_sp.dart';
                        ...
                        SlidableAction(
                          ...
                          onPressed: (context) {
                            Navigator.of(context).push(
                              MaterialPageRoute(builder: (context) => PageCapNhatSP_Admin(fruitSnapshot: fsn),)
                            );
                          },
                        ),
                        SlidableAction(
