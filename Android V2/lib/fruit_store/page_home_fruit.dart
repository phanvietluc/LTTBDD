              ...
              (sp) => GestureDetector(
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      Expanded(
                        child: sp.url == null ? Icon(Icons.image_not_supported):Image.network(sp.url!),
                      ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: f.url == null ? Icon(Icons.image_not_supported):Image.network(f.url!),
            ),
